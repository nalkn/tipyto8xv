# Use a Python debugger to send python programs

With VScode, to make it easier to transfer Python files to the calculator, you can use a Python debugger.

## Installation

Create a `.vscode` directory with the file `launch.json` :
...
Then, create the file `send.py` in `.vscode` with :
...
Now, you can send a Python program to your calculator when pressing `F5` !

To run this program, you need to go to on the Python App of your calculator.
